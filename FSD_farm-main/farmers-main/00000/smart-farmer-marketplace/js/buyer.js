...
(function () {
    ...
    const buyerAvatarInput = document.getElementById('buyerAvatarInput');
    ...
    function hydrateProfile() {
        ...
        if (buyerAvatar) {
            if (user.avatar) {
                buyerAvatar.innerHTML = '';
                const img = document.createElement('img');
                img.src = user.avatar;
                img.alt = user.name;
                buyerAvatar.appendChild(img);
            } else {
    ...
    buyerAvatarInput?.addEventListener('change', function () {
